...
class trans():
    def __init__(self):
        self.type_dict = {"bool":"boolean", "char":"char", "int":"int",
    ...
    def late(self, parsed):
        # parsed - массив
        java_skeleton = self.__main_change(parsed)
        print("-------")
        # print(java_skeleton)
        # java_types = self.types(java_skeleton)
        # self.__to_java(java_types, "test")
        # java_loops = self.loops(java_skeleton)
        java_loops = self.find_and_replace_loop(java_skeleton, 0)
        java_types = self.types(java_loops)
        self.__to_java(java_types, "test")
